"""
Django settings for ovvio-wagtail-acer project.
...
ROOT_URLCONF = 'ovvio-wagtail-acer.urls'
...
WSGI_APPLICATION = 'ovvio-wagtail-acer.wsgi.application'
